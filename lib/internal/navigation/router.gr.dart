...
class AppRouter extends _i17.RootStackRouter {
  ...
  final Map<String, _i17.PageFactory> pagesMap = {
    Selector.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i1.ScreenSelector());
    },
    MainRoute.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i2.MainScope());
    },
    Splash.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i3.SplashScreen());
    },
    OnBoarding.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i4.OnBoarding());
    },
    Login.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i5.LoginScreen());
    },
    Registration.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i6.RegistrationScreen());
    },
    HomeScreen.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i7.HomeScreen());
    },
    CryptoViewRoute.name: (routeData) {
      final args = routeData.argsAs<CryptoViewRouteArgs>();
      return _i17.MaterialPageX<dynamic>(
          routeData: routeData, child: _i8.CryptoViewPage(key: args.key, cryptoEntity: args.cryptoEntity));
    },
    HomeRouteScope.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i9.HomePageScope());
    },
    WalletRoute.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i10.WalletPage());
    },
    ProfileWrapper.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i11.ProfileWrapper());
    },
    HomeRoute.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i12.HomePage());
    },
    SettingsRoute.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i13.SettingsPage());
    },
    ProfileRoute.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i14.ProfilePage());
    },
    MainRegistration.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i15.MainRegistrationPage());
    },
    SmsVerification.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(routeData: routeData, child: const _i16.SmsVerificationPage());
    }
  };
  ...
  List<_i17.RouteConfig> get routes => [
        _i17.RouteConfig(Selector.name, path: '/', children: [
          _i17.RouteConfig('#redirect', path: '', parent: Selector.name, redirectTo: 'splash', fullMatch: true),
          _i17.RouteConfig(MainRoute.name, path: 'mainRoute', parent: Selector.name, children: [
            _i17.RouteConfig('#redirect', path: '', parent: MainRoute.name, redirectTo: 'app', fullMatch: true),
            _i17.RouteConfig(HomeScreen.name, path: 'app', parent: MainRoute.name, children: [
              _i17.RouteConfig('#redirect',
                  path: '', parent: HomeScreen.name, redirectTo: 'homeScope', fullMatch: true),
              _i17.RouteConfig(HomeRouteScope.name, path: 'homeScope', parent: HomeScreen.name, children: [
                _i17.RouteConfig('#redirect',
                    path: '', parent: HomeRouteScope.name, redirectTo: 'home', fullMatch: true),
                _i17.RouteConfig(HomeRoute.name, path: 'home', parent: HomeRouteScope.name)
              ]),
              _i17.RouteConfig(WalletRoute.name, path: 'wallet', parent: HomeScreen.name),
              _i17.RouteConfig(ProfileWrapper.name, path: 'profileScope', parent: HomeScreen.name, children: [
                _i17.RouteConfig('#redirect',
                    path: '', parent: ProfileWrapper.name, redirectTo: 'profile', fullMatch: true),
                _i17.RouteConfig(SettingsRoute.name, path: 'settings', parent: ProfileWrapper.name),
                _i17.RouteConfig(ProfileRoute.name, path: 'profile', parent: ProfileWrapper.name)
              ])
            ]),
            _i17.RouteConfig(CryptoViewRoute.name, path: 'cryptoView', parent: MainRoute.name)
          ]),
          _i17.RouteConfig(Splash.name, path: 'splash', parent: Selector.name),
          _i17.RouteConfig(OnBoarding.name, path: 'onBoarding', parent: Selector.name),
          _i17.RouteConfig(Login.name, path: 'login', parent: Selector.name),
          _i17.RouteConfig(Registration.name, path: 'registration', parent: Selector.name, children: [
            _i17.RouteConfig('#redirect',
                path: '', parent: Registration.name, redirectTo: 'mainRegistration', fullMatch: true),
            _i17.RouteConfig(MainRegistration.name, path: 'mainRegistration', parent: Registration.name),
            _i17.RouteConfig(SmsVerification.name, path: 'smsVerification', parent: Registration.name)
          ])
        ])
      ];
}
...
class Selector extends _i17.PageRouteInfo<void> {
  const Selector({List<_i17.PageRouteInfo>? children}) : super(Selector.name, path: '/', initialChildren: children);
...
class Registration extends _i17.PageRouteInfo<void> {
  const Registration({List<_i17.PageRouteInfo>? children})
      : super(Registration.name, path: 'registration', initialChildren: children);
...
class MainRegistration extends _i17.PageRouteInfo<void> {
  const MainRegistration() : super(MainRegistration.name, path: 'mainRegistration');
...
class SmsVerification extends _i17.PageRouteInfo<void> {
  const SmsVerification() : super(SmsVerification.name, path: 'smsVerification');
