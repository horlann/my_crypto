...
CryptoRemoteModelFromCoinGecko _$CryptoRemoteModelFromCoinGeckoFromJson(
...
Map<String, dynamic> _$CryptoRemoteModelFromCoinGeckoToJson(
        CryptoRemoteModelFromCoinGecko instance) =>
    <String, dynamic>{
      'id': instance.id,
